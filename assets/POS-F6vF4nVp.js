import{b as ut,r as l,g as I,h as xt,c,o as u,d as s,j as T,e as m,k as y,v as f,l as a,x as X,F as L,m as D,t as p,s as Z,z as bt,B as mt,w as tt,y as j}from"./index-C7vrHgk0.js";import{f as E,t as o}from"./numbers-BTmV-EI5.js";import{c as F}from"./createLucideIcon-Cvb7CoZR.js";import{P as yt}from"./package-5hnWq7on.js";import{P as vt}from"./plus-BliDzUBC.js";import{T as ft}from"./trash-2-BN-TgeyU.js";import{U as gt}from"./user-plus-DeQq8Fmp.js";/**
 ...
 */const kt=F("ShoppingCartIcon",[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]]),jt={class:"grid grid-cols-1 lg:grid-cols-3 gap-6"},$t={class:"lg:col-span-2 space-y-4"},zt={class:"card"},Ct={class:"flex gap-3"},Pt={class:"flex-1 relative"},qt={class:"grid grid-cols-2 md:grid-cols-3 gap-4"},St=["onClick"],Gt={class:"aspect-square bg-gray-100 rounded-lg mb-3 flex items-center justify-center"},Et={class:"font-bold text-gray-900 mb-1 truncate"},Mt={class:"text-sm text-gray-500 mb-2"},Vt={class:"flex items-center justify-between"},Bt={class:"text-lg font-bold text-primary-600"},Ut={class:"space-y-4"},It={class:"card sticky top-24"},Tt={class:"text-xl font-bold mb-4 flex items-center gap-2"},Lt={class:"space-y-3 mb-4 max-h-64 overflow-y-auto"},Dt={key:0,class:"text-center py-8 text-gray-500"},Ft={class:"flex-1"},At={class:"font-medium text-sm"},Nt={class:"text-xs text-gray-500"},Ht={class:"flex items-center gap-2"},Qt=["onClick"],Kt={class:"w-8 text-center font-bold"},Ot=["onClick"],Wt=["onClick"],Rt={class:"mb-4"},Yt={class:"flex gap-2"},Jt=["value"],Xt={class:"border-t pt-4 space-y-2"},Zt={class:"flex justify-between text-sm"},te={class:"font-bold"},ee={class:"flex justify-between text-sm"},se={class:"flex justify-between text-sm"},ne={class:"flex justify-between text-lg font-bold border-t pt-2"},oe={class:"text-primary-600"},ae={class:"flex justify-between text-sm bg-blue-50 p-2 rounded"},ie=["placeholder"],le={key:0,class:"flex justify-between text-sm text-red-600 font-bold"},re={class:"mt-4"},de={class:"grid grid-cols-3 gap-2"},pe=["onClick"],ce={class:"mt-4 space-y-2"},ue=["disabled"],xe={key:0,class:"fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"},be={class:"bg-white rounded-xl p-6 w-full max-w-md"},me={class:"flex gap-3"},ye={class:"bg-white rounded-xl p-6 w-full max-w-md"},ve={class:"flex gap-3"},ze={__name:"POS",setup(fe){const x=ut(),$=l([]),z=l([]),r=l([]),v=l(""),C=l(""),g=l(0),h=l(0),P=l(null),A=l("cash"),M=l(!1),q=l(!1),w=l(""),H=l(null),_=l({name:"",phone:""}),Q=[{value:"cash",label:"نقدي"},{value:"card",label:"بطاقة"},{value:"transfer",label:"تحويل"}],et=I(()=>v.value?$.value.filter(t=>t.name_ar.includes(v.value)||t.barcode.includes(v.value)):$.value.slice(0,12)),K=I(()=>r.value.reduce((t,e)=>t+e.product.selling_price*e.quantity,0)),S=I(()=>K.value+h.value-g.value),O=I(()=>{const t=P.value||S.value;return Math.max(0,S.value-t)}),st=async()=>{if(v.value.length<2){N();return}try{const t=await j.getProducts({search:v.value});$.value=t.data}catch{x.error("فشل البحث")}},nt=()=>{M.value=!0,w.value="",setTimeout(()=>{var t;(t=H.value)==null||t.focus()},100)},W=async()=>{if(w.value)try{const t=await j.searchByBarcode(w.value);R(t.data),M.value=!1,w.value=""}catch{x.error("المنتج غير موجود")}},R=t=>{if(t.stock_quantity===0){x.error("المنتج غير متوفر في المخزون");return}const e=r.value.find(n=>n.product.id===t.id);if(e){if(e.quantity>=t.stock_quantity){x.error("الكمية المطلوبة غير متوفرة");return}e.quantity++}else r.value.push({product:t,quantity:1});x.success("تم إضافة المنتج للسلة")},ot=t=>{if(t.quantity>=t.product.stock_quantity){x.error("الكمية المطلوبة غير متوفرة");return}t.quantity++},at=t=>{t.quantity>1?t.quantity--:Y(t)},Y=t=>{r.value=r.value.filter(e=>e.product.id!==t.product.id)},it=()=>{r.value.length!==0&&confirm("هل أنت متأكد من مسح السلة؟")&&(r.value=[],g.value=0,h.value=0)},lt=async()=>{try{const t=await j.createCustomer(_.value);x.success("تم إضافة العميل بنجاح"),z.value.push(t.data),C.value=t.data.id,q.value=!1,_.value={name:"",phone:""}}catch{x.error("فشل إضافة العميل")}},rt=async()=>{var e,n,d;if(r.value.length===0)return;const t={customer_id:C.value||null,items:r.value.map(i=>({product_id:i.product.id,quantity:i.quantity,unit_price:i.product.selling_price})),tax:h.value,discount:g.value,paid_amount:P.value||S.value,payment_method:A.value};try{const i=await j.createSale(t),V=o(i.data.invoice_number);x.success(`تم إنشاء الفاتورة ${V}`);const B=[];confirm("هل تريد طباعة الفاتورة؟")&&dt(i.data),(e=i.data.customer)!=null&&e.phone&&confirm("هل تريد مشاركة الفاتورة عبر واتساب؟")&&pt(i.data),r.value=[],g.value=0,h.value=0,P.value=null,C.value="",N()}catch(i){x.error(((d=(n=i.response)==null?void 0:n.data)==null?void 0:d.error)||"فشل إنشاء الفاتورة")}},dt=t=>{var b,G;const e=window.open("","_blank"),n=((b=t.items)==null?void 0:b.map(k=>{var J;return`<tr style="border: 1px solid #cbd5e1;">
  ...
  <html dir="rtl">
    ...
    <body>
      <div style="text-align: center; margin-bottom: 15px; border-bottom: 3px solid #3b82f6; padding-bottom: 12px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
        <h1 style="font-size: 26px; color: #1e40af; margin-bottom: 3px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">متجر العطور</h1>
        <h2 style="font-size: 16px; color: #64748b; -webkit-print-color-adjust: exact; print-color-adjust: exact;">فاتورة بيع</h2>
      </div>
      
      <div style="display: flex; justify-content: space-between; margin-bottom: 15px; background: #f8fafc; padding: 10px; border-radius: 6px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
        <div style="flex: 1;">
          <p style="margin: 3px 0; font-size: 12px;"><strong>رقم الفاتورة:</strong> ${o(t.invoice_number)}</p>
          <p style="margin: 3px 0; font-size: 12px;"><strong>التاريخ:</strong> ${o(new Date(t.created_at).toLocaleDateString("en-GB"))}</p>
          <p style="margin: 3px 0; font-size: 12px;"><strong>الوقت:</strong> ${o(new Date(t.created_at).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"}))}</p>
        </div>
      ...
      <table style="width: 100%; border-collapse: collapse; margin: 12px 0; font-size: 11px;">
        <thead>
          <tr>
            <th style="border: 1px solid #cbd5e1; padding: 8px; text-align: right; background-color: #3b82f6; color: white; font-weight: bold; font-size: 12px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">المنتج</th>
            <th style="border: 1px solid #cbd5e1; padding: 8px; text-align: center; background-color: #3b82f6; color: white; font-weight: bold; font-size: 12px; width: 60px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">الكمية</th>
            <th style="border: 1px solid #cbd5e1; padding: 8px; text-align: right; background-color: #3b82f6; color: white; font-weight: bold; font-size: 12px; width: 90px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">السعر</th>
            <th style="border: 1px solid #cbd5e1; padding: 8px; text-align: right; background-color: #3b82f6; color: white; font-weight: bold; font-size: 12px; width: 90px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">الإجمالي</th>
          </tr>
        </thead>
        <tbody>${n}</tbody>
      </table>
      ...
      <div style="margin-top: 20px; float: left; width: 50%;">
        <div style="display: flex; justify-content: space-between; padding: 6px 12px; border-bottom: 1px solid #e2e8f0; font-size: 11px;">
